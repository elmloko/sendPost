...
-- Volcando datos para la tabla sendpost.pulse_aggregates: ~157 rows (aproximadamente)
INSERT INTO `pulse_aggregates` (`id`, `bucket`, `period`, `type`, `key`, `aggregate`, `value`, `count`) VALUES
	...
	(406, 1739286720, 1440, 'user_request', '1', 'count', 5.00, NULL),
	(407, 1739283840, 10080, 'user_request', '1', 'count', 5.00, NULL),
...
-- Volcando datos para la tabla sendpost.pulse_entries: ~102 rows (aproximadamente)
